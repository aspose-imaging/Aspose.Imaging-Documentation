...
description: A tool that uses the LSB (Least Significant Bit) steganography algorithm embeds a digital signature directly into image pixel data. Java code example provided.
---
...
- [EmbedDigitalSignature](https://reference.aspose.com/imaging/java/aspose.imaging/rasterimage/embeddigitalsignature/)  method from the Aspose.Imaging library. **Embed LSB data** based on provided password into image pixel data. 
...
- Check image signing by:
  - [IsDigitalSigned](https://reference.aspose.com/imaging/java/aspose.imaging/rasterimage/isdigitalsigned/). You can **quickly verify** whether an image is digitally signed using the provided password.
  ...
  - [AnalyzePercentageDigitalSignature](https://reference.aspose.com/imaging/java/aspose.imaging/rasterimage/analyzepercentagedigitalsignature/).**Precise image check digital signing**. 
