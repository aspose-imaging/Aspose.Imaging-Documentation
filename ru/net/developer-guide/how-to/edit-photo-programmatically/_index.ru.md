...
type: docs
weight: '90'
url: /ru/net/developer-guide/how-to/edit-photo-programmatically
...
<p align='justify'>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
In this article, we consider how to use the most demanded operations for image editing with Aspose.Imaging C# library. Please follow the link to see the table with the list of all <a href="https://docs.aspose.com/imaging/ru/net/supported-file-formats/">supported image formats</a>.
</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
The more detailed description of resize, crop and rotate operations you can find in the [Aspose.Imaging official documentation](https://docs.aspose.com/imaging/ru/net/crop-rotate-and-resize-images/).
...
<img src="images/sample.webp" alt="Sample image" width="640" height="400"/>

Image with Gauss blur rectangle area filter applied:

<img src="images/gauss_blur_filter.webp" alt="Image with Gauss blur rectangle area filter applied" width="640" height="400"/>
...
<img src="images/merge_images.webp" alt="Merged two images into one collage" width="640" height="200"/>
