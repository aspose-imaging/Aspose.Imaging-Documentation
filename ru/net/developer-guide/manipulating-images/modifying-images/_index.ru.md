...
### **Adjusting Contrast**
The AdjustContrast method exposed by the [RasterImage](https://reference.aspose.com/imaging/ru/net/aspose.imaging/rasterimage) class can be used to adjust the **Contrast** of an image by passing a float value as parameter.

{{< gist "aspose-com-gists" "cf3a972847f597d2a33de220c99437e2" "adjust-contrast.cs" >}}
...
### **Adjusting Gamma**
The AdjustGamma method exposed by the [RasterImage](https://reference.aspose.com/imaging/ru/net/aspose.imaging/rasterimage) class has two versions. One of the overloads accept one float value and performs the **Gamma** correction for red, blue & green channel coefficients. Whereas the other overload accepts three float parameters representing each color coefficient separately. The following code example demonstrates how to AdjustGamma on an image.
...
{{< gist "aspose-com-gists" "cf3a972847f597d2a33de220c99437e2" "verify-image-transparency.cs" >}}
