...
The Aspose.Imaging for Java API supports two different approaches to Metafile cropping: by [shifts](/imaging/ru/java/manipulating-metafiles/) and [rectangle](/imaging/ru/java/manipulating-metafiles/).
#### **Cropping by Shifts**
